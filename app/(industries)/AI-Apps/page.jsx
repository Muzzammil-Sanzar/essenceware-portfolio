...
export default async function page() {
  const industry = {
    ...
    shortTaglineMobile:
      "machine learning integration, predictive analytics, natural language processing, and more.",
    app: "Super GPT",
    introduction:
    ...
    problemStatement:
      "People and businesses find it hard to keep up with making lots of good content regularly. They need help managing different types of content and want an easier way to interact with their tech tools.",
    problemExplanation:
    ...
    solutionStatement:
      "SuperGPT app was created to help by automatically making and summarizing content, letting users add their documents and use voice commands. This makes creating different kinds of content faster and simpler.",
    solutionExplanation:
