...
export default async function page() {
  const industry = {
    ...
    shortTaglineMobile:
      "online browsing, product discovery, order tracking, and more.",
    app: "Romolo",
    introduction:
    ...
    problemStatement:
      "Small businesses often find it hard to get noticed and keep customers because they don't have a lot of money for marketing and they make mistakes in processing orders.",
    ...
    solutionStatement:
      "The Romolo app helps small businesses by making it easy to promote their products, automating how orders are processed, and keeping a good track of inventory.",
