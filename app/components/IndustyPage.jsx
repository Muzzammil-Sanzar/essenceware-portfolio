...
import BtnBar from "@/app/components/NavBar/BtnBar";
import BtnMobileBar from "@/app/components/NavBar/BtnMobileBar";
// Client Comps
...
const MenuIcon = dynamic(() => import("@/app/components/NavBar/MenuIcon"), {
  ssr: false,
});
// import CustomVideo from "./video/CustomVideo";
const CustomVideo = dynamic(() => import("./video/CustomVideo"), {
  ssr: false,
});
...
export default async function IndustryPage({ industry }) {
  return (
    <>
      <SlugNavBar />
      <div className="relative  w-full h-full transform overflow-hidden bg-white overflow-y-auto custom-scrollbar text-left align-middle transition-all">
          ...
          <div className="absolute top-4 px-4 sm:px-8 flex items-start justify-start  w-full">
            <div className="z-50 max-w-screen-1xl w-full border-b pb-5 ">
              <div className="w-full flex justify-between items-center">
                ...
                <div className="lg:flex hidden gap-3.5 xl:gap-8 items-center md:justify-center lg:text-base text-sm text-gray-200 w-full whitespace-nowrap">
                  <Link
                    href={"/"}
                    className="text-xs lg:text-sm font-medium hover:text-blue-150 transition duration-300 flex items-center gap-0.5"
                  >
          ...
          <div className="absolute bgg top-0 h-full w-full flex flex-col justify-between px-3.5 sm:px-8">
            <div className="h-full w-full mt-28 sm:mt-32">
              ...
              <div className=" text-white text-center space-y-1">
                ...
                <p className="text-[15px] mt-3 sm:text-sm capitalize sm:hidden block sm:font-medium max-w-72 sm:max-w-md mx-auto">
                  {industry?.shortTaglineMobile}
                </p>
              </div>
              <div className="">
                <div className={syne.className}>
              ...
              <div className="absolute bottom-0 left-0 z-20 flex justify-center w-full">
                <Image
                  ...
                  src={
                    "https://res.cloudinary.com/dprxdqfxc/image/upload/v1720645386/header/A_abfuvv.webp"
                  }
                  alt="team"
                  width={1000}
                  height={1000}
        ...
        <div
          id="body"
          className="xl:py-20  max-w-[1440px] mx-auto px-5 sm:px-8"
        >
          <BtnMobileBar />
          {/* <CustomVideo /> */}
          {/* first section */}
          <div
            ...
            className="grid md:mt-0 grid-cols-12 home-section place-content-end gap-y-6"
          >
            <div className="space-y-3 md:mt-0 self-center sm:space-y-6 col-span-12 md:col-span-8 lg:col-span-5">
              <div className="mb-16 mt-10 border-t border-[#DADBDD] w-full"></div>
              <h1 className="font-medium text-3xl lg:text-xl xl:text-2xl 1xl:text-3xl lg:text-black ">
                We Developed {industry?.app} with these{" "}
                <span className="text-blue-150 font-semibold">Features:</span>
              </h1>
              <p className="font-medium text-lg italic max-w-md text-gray-450"></p>

              <div className="text-base md:space-y-1">
                {industry?.introBulletPoints?.map((bullet, index) => (
                  <li
                    className={`font-thin text-[16px] md:text-[17px]`}
                    key={index}
                  >
                    {bullet}
                  </li>
                ...
                <li
                  className={`font-normal text-[16px] ${"[&::marker]:text-white"}`}
                >
                  and more...
                </li>
              </div>
              ...
              <p>
                Launch your {industry?.title} app business with our development
                services.
              </p>
            </div>
          ...
          >
            {/* <div>
              <p className="text-base font-semibold">Problem Discovery</p>
          ...
          <div data-section-name="home" className="space-y-16 mt-10">
            <div className="max-w-[606px] w-full mx-auto space-y-2.5 lg:space-y-5">
              <p className="text-2xl lg:text-2xl my-6 lg:mt-36 font-medium text-center md:text-center">
                Unique <span className="text-blue-150">Selling Point</span>
              </p>
              <h1 className="font-normal text-xl lg:text-xxl text-center md:text-center">
                {industry?.solutionStatement}
              </h1>
            </div>
            <div>
              <h2 className="text-[32px] mb-10 mt-20 lg:mt-32 text-center md:text-center font-medium ">
                Check Out All{" "}
                <span className="text-blue-150 font-semibold">
                  {" "}
                  App Screens!
                </span>
              </h2>
            ...
            {/* Image Comp */}
            <div className="max-w-screen-2xl lg:max-w-2xl  xl:max-w-[930px] w-full mx-auto">
              <h1 className="pl-6 lg:pl-7 font-medium text-[22px] my-2 lg:my-5">
                Similar Projects
              </h1>
              <WorkCara2 />
            </div>
          ...
          <>
            ...
            <div
              ...
              id="process"
              className="lg:space-y-20 space-y-8"
            >
              <div className={syne.className}>
                <h1 className="text-[23px] md:text-3xl lg:text-4xl xl:text-[44px] font-bold text-center">
                  Four <span className="text-blue-150"> Steps </span> to{" "}
                  {industry?.title} App Development
                </h1>
              </div>
              ...
              <div>
                ...
                <div className="flex justify-between  md:hidden items-stretch">
                  <div className="basis-[50%]  flex flex-1 gap-5 flex-col justify-center">
                    {/* <h2 className="text-4xl text-blue-150 font-medium">
                      Steps:
                    </h2> */}
                    <div className="flex flex-col gap-5">
                      <div className="">
                        ...
                        <p className="text-sm sm:text-base text-gray-450 max-w-xs w-full pr-8">
                          Talk to our team about your app idea to see if users
                          will like it.
                        </p>
                      </div>
                      <div className="">
                        ...
                        <p className="text-sm sm:text-base text-gray-450 max-w-xs w-full pr-8">
                          A Google certified developer leads your app's detailed
                          planning.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="basis-[50%] flex flex-1  flex-col justify-between ">
                    <Image
                      priority={false}
                      loading="lazy"
                ...
                <div className=" flex justify-between md:hidden mt-2 items-start">
                  ...
                  <div className="space-y-4">
                    <div className="">
                      ...
                      <p className="text-sm sm:text-base text-gray-450 max-w-xs w-full">
                        Post-approval, we begin app development, updating you
                        throughout.
                      </p>
                    </div>
                  </div>
