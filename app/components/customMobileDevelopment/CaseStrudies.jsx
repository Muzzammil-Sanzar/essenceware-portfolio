  ...
  return (
    <div className="space-y-10 max-w-screen-lg mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-x-10 gap-y-16">
        <Link href={"/custom-mobile-development/E-commerce"}>
        ...
        <Link href={"/custom-mobile-development/Social-Media"}>
          <div className="space-y-4 cursor-pointer hover:drop-shadow-xl duration-200 hover:p-[2px] hover:rounded-2xl ease-linear">
            <Image
              src={
        ...
        <Link href={"/custom-mobile-development/AI-Apps"}>
          <div className="space-y-4 cursor-pointer hover:drop-shadow-xl duration-200 hover:p-[2px] hover:rounded-2xl ease-linear">
            <Image
              src={
        ...
        <Link href={"/custom-mobile-development/Fintech"}>
          <div className="space-y-4 cursor-pointer hover:drop-shadow-xl duration-200 hover:p-[2px] hover:rounded-2xl ease-linear">
            <Image
              src={
        ...
        <Link href={"/custom-mobile-development/IOT-Apps"}>
          <div className="space-y-4 cursor-pointer hover:drop-shadow-xl duration-200 hover:p-[2px] hover:rounded-2xl ease-linear">
            <Image
              src={
        ...
        <Link href={"/custom-mobile-development/Delivery-Apps"}>
          <div className="space-y-4 cursor-pointer hover:drop-shadow-xl duration-200 hover:p-[2px] hover:rounded-2xl ease-linear">
            <Image
              src={
