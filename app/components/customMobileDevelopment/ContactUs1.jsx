        ...
        <form id="getInTouchForm" className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div>
            {isLoading ? (
              <button
                type="submit"
                className="py-2 bg-blue-110 rounded-lg text-white text-base font-semibold w-full sm:w-[155px]"
              >
                Submitting...
              </button>
            ) : (
              <button
                type="submit"
                className="py-2 bg-blue-110 rounded-lg text-white text-base font-semibold uppercase w-full sm:w-[155px]"
              >
                get in touch
              </button>
            )}
