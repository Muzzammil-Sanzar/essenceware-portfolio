      ...
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog as="div" className="relative z-50" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full h-screen items-center justify-center text-center flex-col p-4">
              <Transition.Child
                as={Fragment}
                enter="ease-out duration-300"
                          ...
                          >
                            ...
                            <div className="flex justify-center sm:justify-start">
                              {isLoading ? (
                                ...
                                <button
                                  type="submit"
                                  className="py-2 bg-blue-110 rounded-lg text-white text-base font-semibold uppercase w-[155px]"
                                >
                                  get in touch
                                </button>
                              )}
