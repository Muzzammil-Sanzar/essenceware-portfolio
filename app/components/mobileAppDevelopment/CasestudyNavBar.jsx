...
export default function CasestudyNavbar({ activeSection, link }) {
      ...
      <div className="max-w-screen-1xl w-full mx-auto">
        <div className="flex items-center justify-between w-full mt-4">
          <div className="flex justify-between w-full items-center">
            <div className="flex items-start gap-2.5">
              <div className="inline-block">
                <Link href={link || `/Mobile-App-Development`}>
                  <Image src={'https://res.cloudinary.com/dprxdqfxc/image/upload/v1719470799/Duseca%20Logo/sdfg_skigtp.webp'} width={186} height={63.29} />
                </Link>
              </div>
            ...
            <div className="md:hidden">
              <div className="md:hidden space-y-1.5">
                ...
                {/* <button
                  ...
                  className="text-[11px] xxs:text-xs w-full font-semibold flex items-center gap-1.5 text-white bg-blue-150 px-3 py-2 rounded-lg whitespace-nowrap"
                >
                  <svg
          ...
          <div className="md:flex flex-col gap-2 hidden">
            ...
            {/* <button
              onClick={(e) => setisOpen(true)}
              className="text-sm xxs:text-sm w-full font-semibold flex justify-center items-center gap-1.5 text-white bg-blue-150 px-5 py-2 rounded-lg whitespace-nowrap"
            >
              <svg
        ...
        <div className="w-full border-b-[1px] border-blue-110/[44%] md:mt-3.5 xl:mt-0">
          <div className="overflow-x-auto cursor-pointer custom-scroll">
            <div className="flex gap-8 items-center  sm:justify-center lg:text-base text-sm text-gray-350 w-full whitespace-nowrap">
              <Link
                href={link || `/Mobile-App-Development`}
                className={`pb-2 md:mt-0 mt-4 text-xs lg:text-sm ${activeSection === "home" &&
                  "text-blue-150 border-b-[2.5px] border-blue-150"
                  } font-medium hover:text-blue-150 transition duration-300 flex items-center gap-0.5`}
              >
                <GoHomeFill /> Home
              </Link>
              ...
              {/* <NavLink
                ...
                scrollTo="#appIndustry"
                isActive={activeSection === "appIndustry"}
              /> */}
              {/* <NavLink
                label="Portfolio"
                scrollTo="#portfolio"
              ...
              <NavLink
                label="Contact Us"
                scrollTo="#contactus"
                isActive={activeSection === "contactus"}
              />
              <NavLink
                label="Reviews"
                scrollTo="#reviews"
...
const NavLink = ({ label, scrollTo, isActive }) => (
  <a
    ...
    className={`pb-2 md:mt-0 mt-4 text-xs lg:text-sm font-medium ${isActive
      ? "text-blue-150 border-b-[2.5px] border-blue-150"
