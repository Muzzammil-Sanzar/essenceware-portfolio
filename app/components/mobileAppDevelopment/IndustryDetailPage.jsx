...
import IndustryDetailPageBtn from "./IndustryDetailPageBtn";
import IndustryDetailPageNavbar from "./IndustryDetailPageNavbar";
import Link from "next/link";
import IndustrialDetailPageFooter from "./IndustrialDetailPageFooter";

export default function IndustryDetailPage({ industry, link }) {
  return (
    <div className="bg-[#F6F6F6] min-h-screen ">
      <IndustryDetailPageNavbar />
      <div className="max-w-screen-1xl mx-auto px-4 lg:px-8 1xl:px-12 space-y-36 my-16 pt-28">
        <div className="space-y-8 lg:space-y-12">
          <div className="w-fit">
            <Link href={link ? `${link}` : `/Mobile-App-Development`} className="w-fit">
