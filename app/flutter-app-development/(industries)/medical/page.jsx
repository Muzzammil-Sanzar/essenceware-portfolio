...
export default function page() {
  const industry = {
    name: "Medical",
    image:
      "https://res.cloudinary.com/dprxdqfxc/image/upload/v1722341566/Duseca%20Landing%20Page-1/App%20Ind-Thumbnails/MEDICAL_gt2azl.png",
    des1: "This mobile app is designed to streamline your medical experience. With our app, you can easily find the nearest hospitals and get the best medical attention you deserve. Sit back and enjoy the leisure provided by using the app. Our app makes the medical experience a breeze.",
