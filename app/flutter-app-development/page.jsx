...
export default function Page() {
  return (
    <div className="bg-[#F6F6F6] relative">
      <MobileAppDevelopmentNavbar link={"/flutter-app-development"} />
      <div className="max-w-screen-1xl mx-auto px-4 lg:px-8 1xl:px-12 space-y-20 pt-40">
        <div id="herosection" data-section-name="herosection">
          <HeloSection
            header={"Flutter App Development Company Custom-Coded Flutter Apps That Bring Your Ideas to Life"}
            des={"Duseca Software specializes in custom Flutter mobile app development, with over 700 unique, user-friendly apps delivered and a reputation backed by 500+ 5-star reviews. Our expert developers build apps from scratch with tailored features to make your app stand out. Book a free consultation for guidance and insights on your Flutter app today!"}
          />
        </div>
        ...
        <div id="industries" data-section-name="industries">
          <IndustriesSection link={"/flutter-app-development"} />
        </div>
        <div className="my-16 border-t border-[#DADBDD] w-full"></div>
        ...
        <div id="casestudies1" data-section-name="casestudies1">
          <CaseStrudies link={"/flutter-app-development"} />
        </div>
        <div className="my-16 border-t border-[#DADBDD] w-full"></div>
