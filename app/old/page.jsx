  ...
  return (
    <>
      ...
      <div className="relative  w-full h-full transform overflow-hidden bg-white overflow-y-auto custom-scrollbar text-left align-middle transition-all">
            ...
            <div className="relative flex items-end justify-between">
              ...
              <div className="">
                <div className={syne.className}>
                  ...
                  >
                    <h2 className="text-2xl 1xl:text-[35px] max-w-xs">
                      MOBILE APP{" "}
                      <span className="text-base 1xl:text-[27px]">
                        DEVELOPMENT
                      </span>
                    </h2>
                    <h3 className="text-2xl 1xl:text-[35px]">AGENCY</h3>
                  </div>
                  ...
                  <div
                    className={`absolute right-0 top-0 font-bold text-white leading-8 space-y-2`}
                  >
                    <div className=" max-w-[170px] w-full">
                      <h3 className="text-2xl 1xl:text-[40px]">700+ APPS</h3>
                      <h2 className="text-sm 1xl:text-lg ">DEVELOPED</h2>
                    </div>
                  </div>
                </div>
        ...
        <div id="body" className="xl:py-20 max-w-[1440px] mx-auto px-6 sm:px-8">
          <BtnMobileBar />
          {/* first section */}
          <div
            id="home"
            data-section-name="home"
            className="grid grid-cols-12 home-section place-content-end gap-y-6"
          >
            <div className="space-y-3  sm:space-y-6 col-span-12 md:col-span-8 lg:col-span-5">
              <h1 className="font-semibold text-3xl lg:text-xl xl:text-2xl 1xl:text-3xl">
          ...
          <div
            data-section-name="home"
            className="max-w-[606px]  w-full mx-auto space-y-2.5 lg:space-y-5"
          >
          ...
          {/* Solution Section */}
          <div data-section-name="home" className="space-y-16">
          ...
          <>
            ...
            >
              ...
              <div className="grid grid-rows-6 md:grid-rows-3 lg:grid-rows-2 grid-flow-col gap-y-5 md:gap-y-10 lg:gap-y-16 md:gap-x-6 lg:gap-x-4">
